    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="عنوان المنشور"  value="{{$post->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">أقتباس</label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">وصف مفصل</label>
        ...
        <div class="form-group">
          <label for="post_cat_id">تصنيف المنشور <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="added_by">الكاتب</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>غير فعال</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
