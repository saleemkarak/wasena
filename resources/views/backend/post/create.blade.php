...
<div class="card">
    <h5 class="card-header">اضف منشور</h5>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        {{csrf_field()}}
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">العنوان <span class="text-danger">*</span></label>
          <input id="inputTitle" type="text" name="title" placeholder="عنوان المنشور"  value="{{old('title')}}" class="form-control">
          @error('title')
