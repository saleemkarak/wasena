...
<div class="card">
    <h5 class="card-header">تعديل التصنيف</h5>
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="ضع عنوان مناسب"  value="{{$category->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">الخلاصة</label>
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
              ...
              <option value="inactive" {{(($category->status=='inactive')? 'selected' : '')}}>غير فعال</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
