            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">تتبع الشحنة</a></li>
                            {{-- <li><i class="ti-alarm-clock"></i> <a href="#">Daily deal</a></li> --}}
                            @auth
                                @if(Auth::user()->role=='admin')
                                    <li><i class="ti-user"></i> <a href="{{route('admin')}}"  target="_blank">لوحة التحكم</a></li>
                                @else
                                    <li><i class="ti-user"></i> <a href="{{route('user')}}"  target="_blank">لوحة التحكم</a></li>
                                @endif
                                <li><i class="ti-power-off"></i> <a href="{{route('user.logout')}}">تسجيل خروج</a></li>

                            @else
                                <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">دخول /</a> <a href="{{route('register.form')}}">تسجيل</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                    ...
                    <div class="right-bar">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{count(Helper::getAllProductFromWishlist())}} منتج</span>
                                        <a href="{{route('wishlist')}}">قائمة التمنيات</a>
                                    </div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{route('cart')}}" class="btn animate">السلة</a>
                                    </div>
                                </div>
                            @endauth
                            <!--/ End Shopping Item -->
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span>{{count(Helper::getAllProductFromCart())}} منتج</span>
                                        <a href="{{route('cart')}}">شاهد السلة</a>
                                    </div>
                                    <ul class="shopping-list">
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="{{Request::path()=='about-us' ? 'active' : ''}}"><a href="{{route('about-us')}}">عن متجرنا</a></li>
