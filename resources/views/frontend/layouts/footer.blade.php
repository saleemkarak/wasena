				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							...
							<ul>
								<li><a href="{{route('about-us')}}">عن متجرنا</a></li>
								<li><a href="#">Faq</a></li>
					...
					<div class="col-lg-2 col-md-6 col-12">
						...
						<div class="single-footer links">
							...
							<ul>
								...
								<li><a href="#">استرجاع الاموال</a></li>
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © {{date('Y')}} <a href="https:/microjo.site" target="_blank">Microjo.site</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
