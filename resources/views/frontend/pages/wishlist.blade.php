				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">قائمة المفضلات</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								<th>المنتج</th>
								<th>الاسم</th>
								<th class="text-center">المحموع</th>
								<th class="text-center">اضف للسلة</th>
							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class='btn text-white'>أضف للسلة </a></td>
							...
							@else
								<tr>
									<td class="text-center">
										لا يوجد قائمة مفضلة. <a href="{{route('product-grids')}}" style="color:blue;">أستمر في التسوق</a>
