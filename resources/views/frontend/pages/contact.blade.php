...
@section('main-content')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>اكتب لنا رسالة @auth @else<span style="font-size:12px;" class="text-danger">[سجل اولاً ]</span>@endauth</h3>
								</div>
								<form class="form-contact form contact_form" method="post" action="{{route('contact.store')}}" id="contactForm" novalidate="novalidate">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>رقم هاتف<span>*</span></label>
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">اتصل بنا الان:</h4>
									<ul>
								...
								<div class="single-info">
									...
									<h4 class="title">عنوان المتجر</h4>
									<ul>
	...
	<div class="map-section">
		<div id="myMap">
            ...
            <iframe src = {{Helper::settings()->googlmap}} width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
	</div>
	<!--/ End Map Section -->
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-success">شكرا جزيلا</h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<p class="text-success">تم ارسال الرسالة بنجاح .</p>
			</div>
		  </div>
		</div>
	</div>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-warning">نعتذر!</h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<p class="text-warning">حدث خطأ ما</p>
			</div>
		  </div>
		</div>
	</div>
