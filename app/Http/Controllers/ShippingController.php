...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','تم اضافة الشحن بنجاح');
        }
        else{
    ...
    public function edit($id)
    {
        ...
        if(!$shipping){
            request()->session()->flash('error','الشحن غير موجود');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','تم تحديث الشحن بنجاح');
        }
        else{
            request()->session()->flash('error','حدث خطأ معين ');
        }
    ...
    public function destroy($id)
    {
        ...
        if($shipping){
            ...
            request()->session()->flash('error','غير متوفر الشحن');
